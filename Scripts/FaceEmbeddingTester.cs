...
public class FaceEmbeddingTester : MonoBehaviour
{
    ...
    [SerializeField] private ModelAsset mobileFaceNetModelAsset;

    [Header("Test Input")]
    [SerializeField] private RefPhoto[] referencePhotos; // 112x112 pixel crop of a face
    [SerializeField] private Texture2D[] testPhotos;
    [SerializeField] private float matchingThreshold = 0.70f;
